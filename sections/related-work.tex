...
Structured streaming~\cite{Armbrust2018} leverages Spark SQL and it compares favourably against the discretized counterpart~\cite{ZahariaDStreams2012} in terms of performance. % approach used in this project. 
