...
In particular, and as detailed later in Chapter \ref{chap:implementation}, \projName uses the \textit{Structured Streaming} API~\cite{structured-streaming-programming-guide}.
